...
//
//class SimpleGenome : public ES::EvolutionaryStrategy{
//private:
...
//		simpleGenome = g;
//	}
//	void addSimpleGenome(std::vector<float>& g)
//	{
...
//	SimpleGenome sg(30, 100, 0.1, 0.1);
//
//	int i = 0;
...
//		sg.addSimpleGenome(temp);	//Temp is an action so needs to be added not set to genome.
//		++i;
//	}
//
